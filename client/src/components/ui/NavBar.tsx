...
export default function NavBar(): JSX.Element {
  ...
  const accountHandler = async (): Promise<void> => {
    navigate('/filter');
  };

  return (
    <Box bg={useColorModeValue('blue.500', 'blue.900')} px={4} boxShadow="dark-lg">
      <Flex h={16} alignItems="center" justifyContent="space-between">
        ...
        <HStack spacing={8} alignItems="center">
          ...
          <Breadcrumb as="nav" separator=">">
            ...
            <BreadcrumbItem>
              <Nlink to="/filter">Account Page</Nlink>
            </BreadcrumbItem>
            {user.status !== 'logged' ? (
              <>
                <BreadcrumbItem>
        ...
        {user.status === 'logged' && (
          <Flex alignItems="center">
            <Menu>
              ...
              <MenuList>
                <MenuItem onClick={accountHandler}>Profile</MenuItem>
